...
RUN_CONFIGS = {
    ...
    "vif_auto_full_history": {
        ...
        "run_name": "1.2 Full-History VIF-Reduced Optuna Tuned Candidate Comparison",
        "report_path": REPORTS_DIR / "full_history_vif_training_report.xlsx",
        "feature_list_path": METADATA_DIR / "full_history_vif_features.txt",
        "selected_model_path": MODELS_DIR / "full_history_vif_model.joblib",
        "figures_dir": FIGURES_BASE_DIR / "full_history_vif",
        "run_type": "full_history_vif_reduced_optuna_tuned_candidate",
        "training_info": (
            "1.2 Full-History VIF-Reduced Optuna Tuned Candidate Comparison. "
            "Uses the VIF-reduced full-history feature set with "
            "Optuna-selected tuned model candidates."
        ),
    },
}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Use 'full' for the 13-feature full-history model or "
            "'vif_auto_full_history' for the 10-feature VIF-reduced model."
        ),
    )
...
def build_run_config(feature_set_name: str) -> dict:
    """
